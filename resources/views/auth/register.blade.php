            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('register') }}" novalidate>
                    ...
                    <div>
                        ...
                        <input type="text" name="username" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 {{ $errors->has('username') ? 'dark:border-red-600 dark:placeholder-red-400' : 'dark:border-gray-600 dark:placeholder-gray-400' }} dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your username" required="">
                        @error('username')
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 {{ $errors->has('email') ? 'dark:border-red-600 dark:placeholder-red-400' : 'dark:border-gray-600 dark:placeholder-gray-400' }} dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="example@example.com" required="">
                        @error('email')
                            <p class="text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
